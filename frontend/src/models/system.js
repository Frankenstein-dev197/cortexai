...
const System = {
  cacheKeys: {
    footerIcons: "cortex_footer_links",
    supportEmail: "cortex_support_email",
    customAppName: "cortex_custom_app_name",
    canViewChatHistory: "cortex_can_view_chat_history",
    deploymentVersion: "cortex_deployment_version",
  },
  ping: async function () {
