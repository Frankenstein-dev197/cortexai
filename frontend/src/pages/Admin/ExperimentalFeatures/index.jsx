...
function FeatureVerification({ children }) {
  if (
    !window.localStorage.getItem("cortex_tos_experimental_feature_set")
  ) {
    function acceptTos(e) {
      e.preventDefault();

      window.localStorage.setItem(
        "cortex_tos_experimental_feature_set",
        "accepted"
      );
      showToast(
          ...
          <form onSubmit={acceptTos} className="flex flex-col gap-y-5">
            ...
            <ModalBody>
              <div className="w-full text-zinc-300 light:text-slate-700 text-md flex flex-col gap-y-4">
                <p>
                  Experimental features of Cortex AI are features that we are
                ...
                <div>
                  ...
                  <ul className="list-disc ml-6 text-sm font-mono mt-2">
                    ...
                    <li>Potential bugs or issues using Cortex AI.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc ml-6 text-sm font-mono mt-2">
                    ...
                    <li>
                      ...
                      configurations, or subscriptions of Cortex AI.
                    </li>
                    <li>
                ...
                <p>
                  ...
                  <a
                    href="https://github.com/Frankenstein-dev197/cortex-ai/tree/main/docs"
                    className="underline text-blue-500"
                  >
                    github.com/Frankenstein-dev197/cortex-ai
                  </a>{" "}
                  or email{" "}
                  <a
                    href="https://github.com/Frankenstein-dev197/cortex-ai/issues"
                    className="underline text-blue-500"
                  >
                    support@cortexai.app
                  </a>
                </p>
              </div>
            </ModalBody>
