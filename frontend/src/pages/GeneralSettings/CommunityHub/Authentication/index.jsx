...
function useCommunityHubAuthentication() {
  ...
  async function disconnectHub() {
    ...
    try {
      ...
      setHasChanges(false);
      showToast("Disconnected from Cortex AI Community Hub", "success");
          ...
          <div className="w-full flex flex-col gap-y-1 pb-6 border-white light:border-theme-sidebar-border border-b-2 border-opacity-10">
            <div className="items-center">
              <p className="text-lg leading-6 font-bold text-theme-text-primary">
                Your Cortex AI Community Hub Account
              </p>
            </div>
            <p className="text-xs leading-[18px] font-base text-theme-text-secondary">
              Connecting your Cortex AI Community Hub account allows you to
              access your <b>private</b> Cortex AI Community Hub items as well
              as upload your own items to the Cortex AI Community Hub.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-y-2">
                <div className="gap-x-2 flex items-center">
                  ...
                  <h1 className="text-lg font-semibold">
                    Why connect my Cortex AI Community Hub account?
                  </h1>
                </div>
                <p className="text-sm text-theme-text-secondary">
                  Connecting your Cortex AI Community Hub account allows you
                  to pull in your <b>private</b> items from the Cortex AI
                  Community Hub as well as upload your own items to the
                  Cortex AI Community Hub.
                  <br />
                  <br />
                  <i>
                    You do not need to connect your Cortex AI Community Hub
                    account to pull in public items from the Cortex AI
                    Community Hub.
                  </i>
                </p>
              </div>
          ...
          <div className="mt-6 mb-12">
            <div className="flex flex-col w-full max-w-[400px]">
              ...
              <input
                ...
                placeholder="Enter your Cortex AI Hub API key"
              />
              <div className="flex items-center justify-between mt-2">
                <p className="text-theme-text-secondary text-xs">
                  ...
                  >
                    Cortex AI Community Hub profile page
                  </a>
                  .
                </p>
                {!!originalConnectionKey && (
