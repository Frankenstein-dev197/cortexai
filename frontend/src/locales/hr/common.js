...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM postavka",
      description:
        "Cortex AI može raditi s mnogim LLM pružateljima usluga. Ovo je usluga koja će upravljati razgovorom.",
    },
    userSetup: {
    ...
    survey: {
      title: "Dobrodošli u Cortex AI",
      description:
        "Pomozite nam da Cortex AI izgradimo prema vašim potrebama. Neobavezno.",
      email: "Koja je vaša e-mail adresa?",
      useCase: "Za što ćete koristiti Cortex AI?",
      useCaseWork: "Za posao",
      useCasePersonal: "Za osobnu upotrebu",
      useCaseOther: "Ostalo",
      comment: "Kako ste čuli za Cortex AI?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "Cortex AI mobilna aplikacija",
    channels: "Kanali",
    "available-channels": {
      telegram: "Telegram",
    },
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Omogućite neograničen broj alata i smanjite potrošnju tokena do 80% po upitu — Cortex AI automatski odabire prave vještine za svaki upit.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description: "Postavite svoje postavke sučelja za Cortex AI.",
    },
    branding: {
      title: "Brendiranje i whitelabeling",
      description:
        "Bijeli žig (white-label) vaše Cortex AI instance s prilagođenim brendiranjem.",
    },
    chat: {
      title: "Razgovor",
      description: "Postavite svoje postavke razgovora za Cortex AI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Jezik prikaza",
        description:
          "Odaberite preferirani jezik za prikaz Cortex AI sučelja - kada su prijevodi dostupni.",
      },
      logo: {
  ...
  api: {
    title: "API ključevi",
    description:
      "API ključevi omogućuju vlasniku programski pristup i upravljanje ovom Cortex AI instancom.",
    ...
    modal: {
      ...
      helper:
        "Nakon stvaranja, API ključ se može koristiti za programski pristup i konfiguraciju ove Cortex AI instance.",
      name: {
        label: "Naziv",
  ...
  llm: {
    title: "LLM postavka",
    description:
      "Ovo su vjerodajnice i postavke za vašeg preferiranog LLM pružatelja usluga razgovora i ugrađivanja (embedding). Važno je da su ovi ključevi ažurni i točni, jer inače Cortex AI neće funkcionirati ispravno.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korištenje lokalnog whisper modela na uređajima s ograničenom RAM memorijom ili procesorom može zaustaviti Cortex AI prilikom obrade medijskih datoteka.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Ugrađivanje (embedding) je proces pretvaranja teksta u vektore. Ove vjerodajnice su potrebne za pretvaranje vaših datoteka i upita u format koji Cortex AI može koristiti za obradu.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Ovo su vjerodajnice i postavke za funkcioniranje vaše Cortex AI instance. Važno je da su ovi ključevi ažurni i točni.",
    provider: {
  ...
  telegram: {
    title: "Telegram bot",
    description:
      "Povežite svoju Cortex AI instancu s Telegramom da biste mogli razgovarati sa svojim radnim prostorima s bilo kojeg uređaja.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Zaštitite svoju Cortex AI instancu lozinkom. Ako je zaboravite, ne postoji način oporavka, tako da svakako spremite ovu lozinku.",
  ...
  privacy: {
    ...
    description:
      "Ovo je vaša konfiguracija za način na koji povezani pružatelji usluga trećih strana i Cortex AI rukuju vašim podacima.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Ove datoteke bit će prenesene u procesor dokumenata koji radi na ovoj Cortex AI instanci. Ove datoteke se ne šalju niti dijele s trećim stranama.",
    },
    pinning: {
      what_pinning: "Što je prikvačivanje dokumenata?",
      pin_explained_block1:
        "Kada <b>prikvačite</b> dokument u Cortex AI-u, ubacit ćemo cijeli sadržaj dokumenta u vaš prozor upita da bi ga vaš LLM potpuno razumio.",
      ...
      pin_explained_block3:
        "Ako ne dobivate željene odgovore od Cortex AI-a prema zadanim postavkama, prikvačivanje je odličan način za dobivanje kvalitetnijih odgovora jednim klikom.",
      accept: "U redu, razumijem",
    },
    watching: {
      what_watching: "Što radi praćenje dokumenta?",
      watch_explained_block1:
        "Kada <b>pratite</b> dokument u Cortex AI-u, <i>automatski</i> ćemo sinkronizirati sadržaj vašeg dokumenta iz njegovog izvornog izvora u redovitim intervalima. Ovo će automatski ažurirati sadržaj u svakom radnom prostoru u kojem se ova datoteka upravlja.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memorija",
        placeholder:
          "npr. Korisnikovo ime je Joe, korisnik radi na Cortex AI-u, itd.",
        create: "Stvori",
        save: "Spremi",
        cancel: "Odustani",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Morate se autentificirati putem Cortex AI Community Hub-a prije objavljivanja stavki.",
