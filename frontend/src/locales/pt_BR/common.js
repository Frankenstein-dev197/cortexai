...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Cortex AI funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao Cortex AI",
      description: "Ajude-nos a melhorar o Cortex AI. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o Cortex AI?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o Cortex AI?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do Cortex AI",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O Cortex AI seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do Cortex AI com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "Depois de criada, a chave de API pode ser usada para acessar e configurar esta instância do Cortex AI programaticamente.",
      name: {
        label: "Nome",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o Cortex AI.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o Cortex AI lidam com seus dados.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do Cortex AI. Não são compartilhados com terceiros.",
    },
    pinning: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memória",
        placeholder:
          "por exemplo, o nome do usuário é Joe, o usuário trabalha com Cortex AI, etc.",
        create: "Criar",
        save: "Salvar",
        cancel: "Cancelar",
      },
  ...
  telegram: {
    ...
    description:
      "Conecte sua instância do Cortex AI ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    setup: {
      step1: {
