...
const SHOW_METRICS_KEY = "cortex_show_chat_metrics";
const SHOW_METRICS_EVENT = "cortex_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `cortex_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `cortex_show_chat_metrics` key
 * @returns {void}
 */
