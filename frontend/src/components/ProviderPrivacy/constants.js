import CortexIcon from "@/media/logo/cortex-icon.png";
...
const VECTOR_DB_PROVIDER_PRIVACY_MAP = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Cortex AI.",
    ],
    logo: LanceDbLogo,
  },
};
...
const EMBEDDING_ENGINE_PROVIDER_PRIVACY_MAP = {
  native: {
    name: "Cortex AI Embedder",
    description: [
      "Your document text is embedded privately on this instance of Cortex AI.",
    ],
    logo: CortexIcon,
  },
  openai: {
