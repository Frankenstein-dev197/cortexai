 ...
 * as well as build features in Cortex AI directly for a specific model or capabilities.
 *
...
/**
 * Returns the user agent for the Cortex AI deployment.
 * @returns {string} The user agent.
 */
function getCortexUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `Cortex AI/${version}`;
}
