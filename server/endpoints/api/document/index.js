...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to Cortex AI to be parsed and prepared for embedding, with optional metadata.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "url": "file:///Users/tim/Documents/cortex-ai/collector/hotdir/cortex.txt",
  ...
  app.post(
    ...
    async (request, response) => {
      /*
      #swagger.tags = ['Documents']
      #swagger.description = 'Upload a new file to a specific folder in Cortex AI to be parsed and prepared for embedding. If the folder does not exist, it will be created.'
  ...
  app.post(
    ...
    async (request, response) => {
      /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Upload a valid URL for Cortex AI to scrape and prepare for embedding. Optionally, specify a comma-separated list of workspace slugs to embed the document into post-upload.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "wordCount": 252,
                  "pageContent": "Cortex AI is the best....",
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in Cortex AI.",
              "addToWorkspaces": "workspace1,workspace2",
              "metadata": {
  ...
  app.get("/v1/document/:docName", [validApiKey], async (request, response) => {
    /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Get a single document by its unique Cortex AI document name'
