...
/**
 * An interface to the Cortex AI Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the Cortex AI instance.
  ...
  /**
   * Apply an item to the Cortex AI instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the Cortex AI instance by downloading the zip file and importing it.
