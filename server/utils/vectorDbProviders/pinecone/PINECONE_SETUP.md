# How to setup Pinecone Vector Database for Cortex AI
...
**Note:** [Namespaces are not supported in `gcp-starter` environments](https://docs.pinecone.io/docs/namespaces) and are required to work with Cortex AI.
