...
class NativeEmbeddingReranker {
  ...
  // This is a folder hosted by the upstream AnythingLLM project for those who cannot capture the HF model download
  // endpoint for various reasons. This endpoint is not guaranteed to be active or maintained
  // and may go offline at any time at the upstream project's discretion.
