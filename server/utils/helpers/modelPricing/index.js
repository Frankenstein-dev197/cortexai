...
/**
 * Cortex AI provider slug -> models.dev provider id.
...
class ModelPricing {
  ...
  /**
   * @param {string|null} providerSlug - Cortex AI provider slug
 ...
 * @param {Object} opts
 * @param {string|null} opts.provider - Cortex AI provider slug
