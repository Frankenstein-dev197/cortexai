...
>
> This will bring Cortex AI's agent capabilities to a new level and a novel UX paradigm for AI Agent use.
>
> ⭐ Star the repo to stay updated!

<p align="center">
  <a href="https://anythingllm.com"><img src="https://github.com/Mintplex-Labs/anything-llm/blob/master/images/wordmark.png?raw=true" alt="Cortex AI logo"></a>
</p>
...
<p align="center">
    <b>Cortex AI:</b> The all-in-one AI app you were looking for.<br />
...
<p align="center">
👉 Cortex AI for desktop (Mac, Windows, & Linux)! <a href="https://anythingllm.com/download" target="_blank"> Download Now</a>
</p>
...
![Chatting](https://github.com/Mintplex-Labs/anything-llm/releases/download/v1.11.2/Cortex AI720p.gif)
...
Cortex AI is the all-in-one AI application that lets you build a private, fully-featured ChatGPT—without compromises. Connect your favorite local or cloud LLM, ingest your documents, and start chatting in minutes. Out of the box you get built-in agents, multi-user support, vector databases, and document pipelines — no extra configuration required.

Cortex AI supports multiple users as well where you can control the access and experience per user without compromising the security or privacy of the instance or your intellectual property.

## Cool Features of Cortex AI
...
- [Cortex AI Native Embedder](/server/storage/models/README.md) (default)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [Cortex AI Built-in](https://github.com/Mintplex-Labs/anything-llm/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
Mintplex Labs & the community maintain a number of deployment methods, scripts, and templates that you can use to run Cortex AI locally. Refer to the table below to read how to deploy on your preferred environment or to automatically deploy.
...
[or set up a production Cortex AI instance without Docker →](./BARE_METAL.md)
...
Cortex AI by Mintplex Labs Inc contains a telemetry feature that collects anonymous usage information.

<details>
<summary><kbd>More about Telemetry & Privacy for Cortex AI</kbd></summary>

### Why?

We use this information to help us understand how Cortex AI is used, to help us prioritize work on new features and bug fixes, and to help us improve Cortex AI's performance and stability.
...
- [Contributing to Cortex AI](./CONTRIBUTING.md) - How to contribute to Cortex AI.
...
- **[Cortex AI Mobile (MIT Licensed)][anythingllm-mobile]:** A mobile application that allows you to use Cortex AI on your mobile device.
- **[Cortex AI Browser Extension][anythingllm-extension]:** A browser extension that allows you to use Cortex AI in your browser.
- **[Cortex AI Embed][anythingllm-embed]:** A widget that allows you to embed Cortex AI in your website.
